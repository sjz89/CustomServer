...
class HorizontalRecyclerviewAdapter extends RecyclerView.Adapter<HorizontalRecyclerviewAdapter.ViewHolder> {
    ...
    HorizontalRecyclerviewAdapter(Context context,List<ImageModel> datas){
        this.datas=datas;
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view =mInflater.inflate(R.layout.item_recyclerview_horizontal, parent, false);
     ...
     * 设置监听器
     */
    void setOnClickItemListener(OnClickItemListener listener){
